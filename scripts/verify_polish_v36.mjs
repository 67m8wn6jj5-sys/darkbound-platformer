...
assert.match(v38,/extends GameSceneV37/,'V38 must preserve V37 and therefore the V36 polish layer');
...
console.log('V36 presentation and traversal polish verification passed beneath V38.');
