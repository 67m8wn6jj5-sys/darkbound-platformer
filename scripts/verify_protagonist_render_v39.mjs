...
assert.match(source,/CACHE_BUST='protagonist-v39-rescue-20260823-1'/);
...
assert.match(source,/art\.setVisible\(true\)\.setDepth\(300\)/);
assert.match(source,/this\.player\.setVisible\?\.\(true\)\.setDepth\?\.\(90\)/);
...
console.log('V39 protagonist render rescue verification passed.');
