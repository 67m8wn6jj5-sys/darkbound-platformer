...
// GameSceneV17 inherits through enemy/boss scene layers whose manifests are
// normally generated by the GitHub Pages asset pipeline and are intentionally
// not stored in source control. Create empty temporary stubs so this unit-level
