...
assert.match(main,/import \{ GameSceneV32 \} from '\.\/GameSceneV32\.js'/,'current main must boot the latest scene');
assert.match(main,/GameSceneV32 -> GameSceneV31 -> GameSceneV30 -> GameSceneV29 -> GameSceneV28 -> GameSceneV27/,'current live chain must retain V27 blade tracking underneath later passes');
assert.match(v32,/extends GameSceneV31/,'V32 must preserve V31');
...
console.log('V27 restored downward ground finisher and blade-locked VFX inheritance verification passed beneath V32.');
