...
def main():
    ...
    if "import { GameSceneV30 } from './GameSceneV30.js'" not in main_source or 'scene: [GameSceneV30]' not in main_source:
        fail('main.js does not boot V30')
    if 'GameSceneV30 -> GameSceneV29 -> GameSceneV28' not in main_source:
        fail('main.js does not document the preserved V30/V29/V28 chain')
