...
const main=readFileSync('src/main.js','utf8');const v36=readFileSync('src/GameSceneV36.js','utf8');const v35=readFileSync('src/GameSceneV35.js','utf8');const v34=readFileSync('src/GameSceneV34.js','utf8');const v33=readFileSync('src/GameSceneV33.js','utf8');
assert.match(main,/import \{ GameSceneV36 \} from '\.\/GameSceneV36\.js'/);assert.match(main,/scene: \[GameSceneV36\]/);assert.match(v36,/extends GameSceneV35/);assert.match(v35,/extends GameSceneV34/);assert.match(v34,/extends GameSceneV33/);assert.match(v33,/extends GameSceneV32/);
...
assert.doesNotMatch(v35,/ENVIRONMENT_ART_V30\.arches/,'V35 must continue rejecting the incomplete arch-object exports');
assert.doesNotMatch(v36,/ENVIRONMENT_ART_V30\.arches/,'V36 must continue rejecting the incomplete arch-object exports');
console.log('Historical V32 asset/dressing verification passed beneath V36.');
