...
export const ENVIRONMENT_ART_V30=Object.freeze({
  foreground:Object.freeze({
    ...
    path:'./pixellab-tileset-ancient-dark-gothic-stone-masonry-large-a89e3ba5.png?v=v31-original-terrain',
  }),
...
export class GameSceneV30 extends GameSceneV29 {
  ...
  // Restore the original approved PixelLab gothic masonry for live terrain.
